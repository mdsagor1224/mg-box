...
use ElementorHelloWorld\widgets\About_Box;
use ElementorHelloWorld\widgets\Cta_Box;
use ElementorHelloWorld\widgets\Pricing_Plan;
...
class Plugin {
	...
	public function register_widgets( $widgets_manager ) {
		...
		require_once( __DIR__ . '/widgets/about-box.php' );
		...
		$widgets_manager->register( new Widgets\About_Box() );
		$widgets_manager->register( new Widgets\Cta_Box() );
		$widgets_manager->register( new Widgets\Pricing_Plan() );
	}
